...
def start(message):
    ...
    markup.add(telebot.types.InlineKeyboardButton("Update Channel", url='t.me/ExistBots'))
...
def analyze(message):
    ...
    if profile_info:
        ...
        markup.add(telebot.types.InlineKeyboardButton("Developer", url='t.me/MutyalaHarshith'))
